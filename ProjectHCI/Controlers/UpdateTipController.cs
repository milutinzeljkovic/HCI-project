...
{
	class UpdateTipController : Controller
	{
		...
		private void doWork(object sender, DoWorkEventArgs e)
		{
			...
			IzmenaTipa i = IzmenaTipa.Instance();
			...
			if (dbCon.IsConnect())
			{
				try
				{
					...
					string query = "Update  hci_tip_table set opis = '" + i.Opis + "', slika = '" + i.Slika + "', ime = '" + i.Ime + "' where oznaka = '" + i.Oznaka + "'";
		...
		private void workCompleted(object sender, RunWorkerCompletedEventArgs e)
		{
			...
			if ((string)e.Result == "uspesno")
			{
				...
				Observers.App.Instance().State = "modifikacija_tipa_uspesno";
